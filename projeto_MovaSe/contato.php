                ...
                <div class="formulario">
                    ...
                    if (isset($_POST['enviar'])) {
                        ...
                        if (!empty($_POST['nome']) && !empty($_POST['email']) && !empty($_POST['celular']) && !empty($_POST['assunto']) && !empty($_POST['mensagem'])) {
                            ...
                            //padrão de formato de data e hora
                            $data = date("Y-m-d H:i:s");

                            //monta a consulta SQL

                            $sql = "INSERT INTO contato_tb ( nome, email, celular, assunto, mensagem, data)";
                            $sql .= "VALUES( '{$nome}', '{$email}', '{$celular}', '{$assunto}', '{$data}')";
                    ...
                    ?>
                        ...
                        ?>
                            ...
                            <p> Volte para o formulário <a href="contato.php"></a></p>
                        <?php
