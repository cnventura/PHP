...
*/
class Pai{
    // criando propriedade | Publica - Protegida - Privada
    public $cor = "Vermelho"; // (sem a identificação de public, protected, private) é pública
    public $largura = "2cm";
...
/* Herança
A classe 'Filho' estende a classe 'Pai', o que siginifica que ela herda todas as propriedades e métodos da classe 'Pai'
*/

class Filho extends Pai{
    function Bemvindo(){
        // Vamos imprimir de uma única vez todos os itens da classe 'Pai'
...
/*Uso do Objeto 'Pai' */
$OBJPAI = new Pai (); // Boas praticas $OBJPAI (tudo em maiusculo para objeto (distingue de variável))
$OBJFILHO = new Filho();
